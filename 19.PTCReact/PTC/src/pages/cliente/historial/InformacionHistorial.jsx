    ...
    <Box sx={{ px: { xs: 2, sm: 4 }, py: 3 }}>
      ...
      <Grid container spacing={3}>
        <Grid item xs={12} md={6}>
          {renderInfoSection('Nombre del Cliente', historial.nombreCliente, <PersonIcon color="primary" />)}
        </Grid>
        <Grid item xs={12} md={6}>
          {renderInfoSection('Fecha de Apertura', formatDate(historial.fechaApertura), <CalendarTodayIcon color="primary" />)}
        </Grid>
      </Grid>
      ...
      <Accordion defaultExpanded>
        ...
        <AccordionDetails>
          {renderInfoSection('Descripción del Objetivo', historial.descripcionObjetivo, <DescriptionIcon color="action" />)}
          {renderInfoSection('Información Inicial', historial.informacionInicial, <InfoIcon color="action" />)}
          {renderInfoSection('Contexto del Caso', historial.contextoCaso, <InfoIcon color="action" />)}
        </AccordionDetails>
      </Accordion>
      ...
      <Accordion>
        ...
        <AccordionDetails>
          {renderInfoSection('Hallazgos Importantes', historial.conclusionesResultados?.hallazgosImportantes)}
          {renderInfoSection('Conclusiones', historial.conclusionesResultados?.conclusiones)}
          {renderInfoSection('Recomendaciones', historial.conclusionesResultados?.recomendaciones)}
        </AccordionDetails>
      </Accordion>
      ...
      <Accordion>
        ...
        <AccordionDetails>
          {renderInfoSection('Fecha de Cierre', formatDate(historial.cierreCaso?.fechaCierre))}
          {renderInfoSection('Resultado Final', historial.cierreCaso?.resultadoFinal)}
        </AccordionDetails>
      </Accordion>
    </Box>
  );
